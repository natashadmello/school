 ...
 *
 * Purpose:
 *  Implements the core logic for a Yatzy (dice game). This module includes functions for simulating
 *  dice rolls, interpreting results, and deciding the winner among multiple players.
 *
 * Program author:
 *  Name: Natasha Dmello
 * */
...
// Moved from functions.cpp to .hh
